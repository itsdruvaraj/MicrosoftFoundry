...
/// </summary>
public sealed class CustomMCPAgentNoAuth
{
    // TODO: Update these to point to your MCP server
    private const string McpServerLabel = "custom_mcp_server";
    private const string McpServerUrl = "https://app-ext-eus2-mcp-profx-02.azurewebsites.net/mcp";
    ...
    public CustomMCPAgentNoAuth(FoundryClientFactory factory)
    {
    ...
    public async Task RunAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            foreach (var question in questions)
            {
                ...
                // Set up MCP tool resources with auto-approval (no authentication required)
